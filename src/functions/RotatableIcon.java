 ...
 *
 * This class is cited and created by Mr. Wachs, my advisor
 * 
 * @author Mr. Wachs 
...
public class RotatableIcon implements Icon 
{
    ...
    private Icon   icon;            // The orignal icon
    private Rotate rotate;          // Use of the enumeration
    private double degrees;         // The amount to rotate (in degrees)

    /**
     * Constructor to create a RotatedIcon that is rotated UP (not rotated)
     * 
     * @param filename the path to the image for the icon
     */
    public RotatableIcon(String filename) {
        ImageIcon originalIcon = new ImageIcon(filename);
        this.icon   = originalIcon;
        this.rotate = Rotate.UP;
    }
    
    /**
     * Constructor that creates a RotatedIcon. The icon will rotate about its 
     * center. This constructor will automatically set the Rotate enum 
     * to ABOUT_CENTER
     * 
     * @param filename the path to the image for the icon
     * @param degrees the degrees of rotation
     */
    public RotatableIcon(String filename, double degrees) {
        ImageIcon originalIcon = new ImageIcon(filename);
        this.icon   = originalIcon;
        this.rotate  = Rotate.ABOUT_CENTER;
     ...
     */
    public RotatableIcon(String filename, Rotate rotate) {
        ImageIcon originalIcon = new ImageIcon(filename);
        this.icon   = originalIcon;
        this.rotate = rotate;
    }
    ...
    /**
     * Constructor to create a RotatedIcon that is rotated UP
     * 
